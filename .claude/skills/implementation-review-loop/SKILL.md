...
2. **Review Round R**: Follow the `eight-agent-review` skill (scope = `session`, targeting all code written this session). Consolidate the findings and write them to `docs/code-reviews/session-NN-round{R}.md`.
3. **Evaluate Findings**:
