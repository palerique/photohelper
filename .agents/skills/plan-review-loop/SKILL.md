...
2. **Review Round R**: Run the `eight-agent-review` skill against the plan. Consolidate the findings and write them to `docs/code-reviews/session-NN-plan-round{R}.md`.
3. **Evaluate Findings**:
...
4. **Autonomous Remediation**:
   ...
   - **Important**: In this loop mode, you do **NOT** pause for user approval before fixing. You autonomously implement the Deep Remediation Blueprint fixes.
